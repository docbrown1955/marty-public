...
optional<Expr> AbstractBuildingBlock::getPolynomialTerm(Expr_info expr,
                                                        int       order) const
{
...
optional<Expr>
AbstractBuildingBlock::findSubExpression(Expr_info   subExpression,
...
Complexified::Complexified() : AbstractBuildingBlock()
{
}

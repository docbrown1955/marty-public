...
class ScalarFieldParent : public FieldParent {
  ...
  public:
    ...
    template <class... Args>
    friend std::shared_ptr<ScalarFieldParent> sfparent_(Args &&... args)
    {
...
class AbstractField : public AbstractElement {
  ...
  public:
    AbstractField(const Tensor &t_vector, const Parent &t_parent);
...
class ScalarField : public AbstractField {
  ...
  public:
    ScalarField(const Tensor &t_vector, const Parent &t_parent);

    explicit ScalarField(const Expr &otherField);

    explicit ScalarField(const Abstract *otherField);

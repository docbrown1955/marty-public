...
class IntFraction : public AbstractNumerical {
  ...
  public:
     ...
     * more general product functions will \b automatically call this one when
     * needed. \param expr Number or IntFraction for the product. \return The
     * product.
     */
    Expr multiplication_own(const Expr &expr, bool side = 1) const override;
     ...
     * \details This function is specialy designed for the multiplication of
     * numbers. It shouldn't be used directly by the user in general, because
     * more general sum functions will \b automatically call this one when
     * needed. \param expr Number or IntFraction for the sum. \return The sum.
     */
    Expr addition_own(const Expr &expr) const override;
...
// The IntFraction constructor with t_num and t_denom is in the .cpp file (more
// complex).
...
class Complex : public AbstractNumerical {
  ...
  public:
     ...
     * \param t_denom Denominator.
     */
    Complex(Expr t_real, Expr t_imag);

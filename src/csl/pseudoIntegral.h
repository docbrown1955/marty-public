...
class PseudoIntegral {
  ...
  private:
    bool testBoundsInfinity(const Expr &inf, const Expr &sup) const;
...
class AbstractIntegral : public Operator<AbstractFunc> {
  ...
  public:
    ...
    explicit AbstractIntegral(const Expr &operand);
...
class ScalarIntegral : public AbstractIntegral {
  ...
  public:
    ...
    explicit ScalarIntegral(const Expr &t_variable);

    ScalarIntegral(const Expr &operand, const Expr &t_variable);
...
class VectorIntegral : public AbstractIntegral {
  ...
  public:
    ...
    explicit VectorIntegral(const Tensor &t_variables);

...
/*!
 * \brief Returns the result of the (anit-)commutation of \b A and \b B. In
 * most cases it returns CSL_0, and returns CSL_UNDEF else. Useful to test if
 * two objects commute.
 *
 ...
 * \brief Returns the result of the (anit-)commutation of \b A and \b B. In
 * most cases it returns CSL_0, and returns CSL_UNDEF else. Useful to test if
 * two objects commute. In the special of this function, \b A is an object that
...
class Commutator : public AbstractDuoFunc {
  ...
  protected:
    /*!
     * \brief Sign of the commutator. +1 for anti-commutator, -1 for
     * commutator.
     */
    int sign;

...
ostream &operator<<(ostream &fout, csl::Type type)
{
    ...
    case csl::Type::TensorFieldElement:
        fout << "TensorFieldElement";
        break;
    case csl::Type::TDerivativeElement:
        fout << "TDerivativeElement";
        break;

    default:
        cout << "Type " << (int) type << " not known in perator<<(Type).";
    }
    return fout;
}
...
ostream &operator<<(ostream &fout, csl::PrimaryType primaryType)
{
    ...
    // an integer.
    switch (primaryType) {
    case csl::PrimaryType::Arbitrary:
        cout << "Arbitrary";
        break;
    case csl::PrimaryType::Numerical:
        cout << "Purely numerical";
        break;
    case csl::PrimaryType::Literal:
        cout << "Variable Numerical";
        break;
    case csl::PrimaryType::MultiFunction:
        cout << "Multi Scalar Function";
        break;
    case csl::PrimaryType::ScalarFunction:
        cout << "Scalar Function";
        break;
    case csl::PrimaryType::Vectorial:
        cout << "Vectorial";
        break;
    case csl::PrimaryType::Indicial:
        cout << "Indicial";
        break;
    case csl::PrimaryType::Field:
        cout << "Field";
        break;

    default:
        cout << "Primary Type " << (int) primaryType;

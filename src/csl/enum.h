...
/*! \brief Displays the name of a given csl::PrimaryType in order to be
 * readable. \param fout Out stream in which the type is send. \param type
 * PrimaryType to display. \return \b fout
 */

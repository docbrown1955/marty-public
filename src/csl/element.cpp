...
AbstractElement::AbstractElement() : Complexified(), parent(nullptr)
{
}

AbstractElement::AbstractElement(const shared_ptr<AbstractParent> &t_parent)
    : Complexified(), parent(t_parent)
{
}
...
optional<Expr> AbstractElement::getPolynomialTerm(Expr_info variable,
                                                  int       order) const
{
...
optional<Expr> AbstractElement::evaluate(csl::eval::mode user_mode) const
{

 ...
 * \details If \a a and \a b are integers ( \a a == floor(\a a) and also for \a
 * b) this function calls PGCD(int a, int b). \param a \param b \return
 * PGCD(a,b) if \a a and \a b are integers. \return \b 1 else.
 */
int PGCD(double a, double b);

/*!
 * \brief Returns the PGCD of a and b.
 * \details Proceeds to verifications on \a a and \a b (sign, non zero, etc)
 * and calls internal_PGCD(int a, int b) if everythiong is Ok. \param a \param
 * b \return PGCD(a,b)
 */

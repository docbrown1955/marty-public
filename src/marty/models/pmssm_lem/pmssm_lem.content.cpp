...
PMSSM_LEM::PMSSM_LEM()
    : mty::Model(), mty::PMSSM_data(mty::dirac4, csl::Minkowski)

{
    ...
    initMass();
    initInteractions();
    replace(1 + csl::pow_s(csl::tan_s(sm_input::theta_W), 2), 
	    csl::pow_s(csl::cos_s(sm_input::theta_W), -2));
    replace(1 + csl::pow_s(csl::tan_s(sm_input::theta_W), -2), 
	    csl::pow_s(csl::sin_s(sm_input::theta_W), -2));
    initSpectrum();
}
...
void PMSSM_LEM::initContent()
{
    ...
    g_s = sm_input::g_s;
    addGaugedGroup(mty::group::Type::SU, "C", 3, g_s);
    ...
    abbreviatedMassExpressions.push_back(csl::Abbrev::makeAbbreviation(
        "m_Hp", csl::sqrt_s(M_A * M_A + M_W * M_W)));
    ...
    csl::Expr m_sc_L_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s({csl::intfraction_s(-1, 2), csl::pow_s(M_W, 2)}),
             csl::pow_s(m_c, 2),
             csl::pow_s(M_q1L, 2),
             csl::prod_s({csl::intfraction_s(1, 12),
                          csl::pow_s(m_Z, 2),
                          csl::pow_s(csl::sin_s(theta_W), 2)}),
             csl::prod_s({csl::intfraction_s(-1, 6),
                          csl::pow_s(m_Z, 2),
                          csl::pow_s(csl::sin_s(beta), 2),
                          csl::pow_s(csl::sin_s(theta_W), 2)})}),
    ...
    csl::Expr m_su_L_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s({csl::intfraction_s(-1, 2), csl::pow_s(M_W, 2)}),
             csl::pow_s(m_u, 2),
             csl::pow_s(M_q1L, 2),
    ...
    csl::Expr m_sc_R_encaps = csl::pow_s(
        csl::sum_s({csl::pow_s(m_c, 2),
                    csl::pow_s(M_quR, 2),
                    csl::prod_s({csl::intfraction_s(1, 3),
                                 csl::pow_s(m_Z, 2),
                                 csl::pow_s(csl::sin_s(theta_W), 2)}),
                    csl::prod_s({csl::intfraction_s(-2, 3),
                                 csl::pow_s(m_Z, 2),
                                 csl::pow_s(csl::sin_s(beta), 2),
                                 csl::pow_s(csl::sin_s(theta_W), 2)})}),
        csl::intfraction_s(1, 2));
    ...
    csl::Expr m_su_R_encaps = csl::pow_s(
        csl::sum_s({csl::pow_s(m_u, 2),
                    csl::pow_s(M_quR, 2),
                    csl::prod_s({csl::intfraction_s(1, 3),
                                 csl::pow_s(m_Z, 2),
                                 csl::pow_s(csl::sin_s(theta_W), 2)}),
    ...
    csl::Expr m_sd_R_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s(
                 {V_td, csl::GetComplexConjugate(V_td), csl::pow_s(M_qbR, 2)}),
             csl::prod_s(
                 {V_cd, csl::GetComplexConjugate(V_cd), csl::pow_s(M_qdR, 2)}),
             csl::prod_s({csl::pow_s(V_ud, 2), csl::pow_s(M_qdR, 2)}),
             csl::prod_s(
                 {csl::pow_s(m_d, 2), csl::pow_s(csl::cos_s(beta), (-2))}),
             csl::prod_s({-1,
                          csl::pow_s(m_d, 2),
                          csl::pow_s(csl::cos_s(beta), (-2)),
                          csl::pow_s(csl::sin_s(beta), 2)}),
             csl::prod_s({csl::intfraction_s(-1, 6),
                          csl::pow_s(m_Z, 2),
                          csl::pow_s(csl::sin_s(theta_W), 2)}),
    ...
    csl::Expr m_ss_R_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s(
                 {V_ts, csl::GetComplexConjugate(V_ts), csl::pow_s(M_qbR, 2)}),
             csl::prod_s(
                 {V_cs, csl::GetComplexConjugate(V_cs), csl::pow_s(M_qdR, 2)}),
             csl::prod_s({csl::pow_s(V_us, 2), csl::pow_s(M_qdR, 2)}),
             csl::prod_s(
                 {csl::pow_s(m_s, 2), csl::pow_s(csl::cos_s(beta), (-2))}),
             csl::prod_s({-1,
                          csl::pow_s(m_s, 2),
                          csl::pow_s(csl::cos_s(beta), (-2)),
                          csl::pow_s(csl::sin_s(beta), 2)}),
    ...
    csl::Expr m_sd_L_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s(
                 {V_cd, csl::GetComplexConjugate(V_cd), csl::pow_s(M_q1L, 2)}),
             csl::prod_s({csl::pow_s(V_ud, 2), csl::pow_s(M_q1L, 2)}),
             csl::prod_s(
                 {V_td, csl::GetComplexConjugate(V_td), csl::pow_s(M_q3L, 2)}),
             csl::prod_s(
                 {csl::pow_s(m_d, 2), csl::pow_s(csl::cos_s(beta), (-2))}),
    ...
    csl::Expr m_ss_L_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s(
                 {V_cs, csl::GetComplexConjugate(V_cs), csl::pow_s(M_q1L, 2)}),
             csl::prod_s({csl::pow_s(V_us, 2), csl::pow_s(M_q1L, 2)}),
             csl::prod_s(
                 {V_ts, csl::GetComplexConjugate(V_ts), csl::pow_s(M_q3L, 2)}),
             csl::prod_s(
                 {csl::pow_s(m_s, 2), csl::pow_s(csl::cos_s(beta), (-2))}),
             csl::prod_s({csl::intfraction_s(-1, 2),
                          csl::pow_s(M_W, 2),
    ...
    M_eR                    = mssm_input::MeR;
    csl::Expr m_se_R_encaps = csl::pow_s(
        csl::sum_s({csl::pow_s(M_eR, 2),
                    csl::prod_s({csl::pow_s(m_e, 2),
                                 csl::pow_s(csl::cos_s(beta), (-2))}),
                    csl::prod_s({-1,
                                 csl::pow_s(m_e, 2),
                                 csl::pow_s(csl::cos_s(beta), (-2)),
    ...
    csl::Expr m_smu_R_encaps = csl::pow_s(
        csl::sum_s({csl::pow_s(M_eR, 2),
                    csl::prod_s({csl::pow_s(m_mu, 2),
                                 csl::pow_s(csl::cos_s(beta), (-2))}),
                    csl::prod_s({-1,
                                 csl::pow_s(m_mu, 2),
                                 csl::pow_s(csl::cos_s(beta), (-2)),
    ...
    M_eL                    = mssm_input::MeL;
    csl::Expr m_se_L_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s({csl::intfraction_s(-1, 2), csl::pow_s(M_W, 2)}),
             csl::pow_s(M_eL, 2),
             csl::prod_s(
                 {csl::pow_s(m_e, 2), csl::pow_s(csl::cos_s(beta), (-2))}),
             csl::prod_s({-1,
                          csl::pow_s(m_e, 2),
                          csl::pow_s(csl::cos_s(beta), (-2)),
                          csl::pow_s(csl::sin_s(beta), 2)}),
    ...
    csl::Expr m_smu_L_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s({csl::intfraction_s(-1, 2), csl::pow_s(M_W, 2)}),
             csl::pow_s(M_eL, 2),
             csl::prod_s(
                 {csl::pow_s(m_mu, 2), csl::pow_s(csl::cos_s(beta), (-2))}),
             csl::prod_s({-1,
                          csl::pow_s(m_mu, 2),
                          csl::pow_s(csl::cos_s(beta), (-2)),
                          csl::pow_s(csl::sin_s(beta), 2)}),
    ...
    csl::Expr m_snu_e_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s({csl::intfraction_s(-1, 2), csl::pow_s(M_W, 2)}),
             csl::pow_s(M_eL, 2),
             csl::prod_s({csl::intfraction_s(-1, 4),
    ...
    csl::Expr m_snu_tau_encaps = csl::pow_s(
        csl::sum_s(
            {csl::prod_s({csl::intfraction_s(-1, 2), csl::pow_s(M_W, 2)}),
             csl::pow_s(M_tauL, 2),
             csl::prod_s({csl::intfraction_s(-1, 4),
    ...
    c_G = mty::ghostboson_s("c_g ; c_{g}",
                            std::dynamic_pointer_cast<mty::VectorBoson>(G));
    addParticle(c_G, false);

    c_A = mty::ghostboson_s("c_A ; c_{A}",
                            std::dynamic_pointer_cast<mty::VectorBoson>(Z));
    addParticle(c_A, false);
    c_Z = mty::ghostboson_s("c_Z ; c_{Z}",
                            std::dynamic_pointer_cast<mty::VectorBoson>(Z));
    addParticle(c_Z, false);
    c_Wp = mty::ghostboson_s("c_Wp ; c_{+}",
                             std::dynamic_pointer_cast<mty::VectorBoson>(W));
    addParticle(c_Wp, false);
    c_Wm = mty::ghostboson_s(
        "c_Wm ; c_{-}", std::dynamic_pointer_cast<mty::VectorBoson>(W), false);
    ...
    Gp = mty::goldstoneboson_s("Gp ; G_W^+",
                               std::dynamic_pointer_cast<mty::VectorBoson>(W));
    addParticle(Gp);

    G0 = mty::goldstoneboson_s("G0 ; G_Z",
                               std::dynamic_pointer_cast<mty::VectorBoson>(Z));
    addParticle(G0);
    ...
    e = mty::diracfermion_s(std::dynamic_pointer_cast<mty::WeylFermion>(e_L),
    ...
    u = mty::diracfermion_s(std::dynamic_pointer_cast<mty::WeylFermion>(u_L),
                            std::dynamic_pointer_cast<mty::WeylFermion>(u_R));
    u->setMass(m_u);
    u->setGroupRep("C", {1, 0});
    addParticle(u, false);

    d = mty::diracfermion_s(std::dynamic_pointer_cast<mty::WeylFermion>(d_L),
                            std::dynamic_pointer_cast<mty::WeylFermion>(d_R));
    d->setMass(m_d);
    d->setGroupRep("C", {1, 0});
    addParticle(d, false);

    s = mty::diracfermion_s(std::dynamic_pointer_cast<mty::WeylFermion>(s_L),
                            std::dynamic_pointer_cast<mty::WeylFermion>(s_R));
    s->setMass(m_s);
    s->setGroupRep("C", {1, 0});
    addParticle(s, false);

    c = mty::diracfermion_s(std::dynamic_pointer_cast<mty::WeylFermion>(c_L),
                            std::dynamic_pointer_cast<mty::WeylFermion>(c_R));
    c->setMass(m_c);
    c->setGroupRep("C", {1, 0});
    addParticle(c, false);

    t = mty::diracfermion_s(std::dynamic_pointer_cast<mty::WeylFermion>(t_L),
                            std::dynamic_pointer_cast<mty::WeylFermion>(t_R));
    t->setMass(m_t);
    t->setGroupRep("C", {1, 0});
    addParticle(t, false);

    b = mty::diracfermion_s(std::dynamic_pointer_cast<mty::WeylFermion>(b_L),
    ...
    C_1_1 = Color->getGroup()->getVectorSpace(
        Color->getGroup()->highestWeightRep({
            1,
            1,
        }));
...
void PMSSM_LEM::initSpectrum()
{
    ...
    addSpectrum(
        ...
        },
        {
            {M_1,
             0,
             csl::prod_s({-2, m_Z, csl::cos_s(beta), csl::sin_s(theta_W)}),
             csl::prod_s({2, m_Z, csl::sin_s(beta), csl::sin_s(theta_W)})},
            {0,
             M_2,
             csl::prod_s({2, M_W, csl::cos_s(beta)}),
             csl::prod_s({-2, M_W, csl::sin_s(beta)})},
            {0, 0, 0, csl::prod_s({-2, mu_h})},
            {0, 0, 0, 0},
        },
        {
            {N_B1, N_B2, N_B3, N_B4},
    ...
    addSpectrum({C_1, C_2},
                {
                    {M_2,
                     csl::prod_s({csl::pow_s(2, csl::intfraction_s(1, 2)),
                                  M_W,
                                  csl::sin_s(beta)})},
                    {csl::prod_s({csl::pow_s(2, csl::intfraction_s(1, 2)),
                                  M_W,
                       ...
                       csl::sum_s(
                           {1,
                            csl::prod_s(
                                {-1, csl::pow_s(csl::sin_s(beta), 2)})}),
                       csl::pow_s(csl::sin_s(theta_W), 2)})}),
             csl::sum_s({csl::prod_s({-2,
                                      mu_h,
                                      m_t,
                                      csl::cos_s(beta),
                                      csl::pow_s(csl::sin_s(beta), (-1))}),
                         csl::prod_s({2,
                                      csl::pow_s(2, csl::intfraction_s(1, 2)),
                                      A_t,
                                      M_W,
                                      csl::pow_s(e_em, (-1)),
                                      csl::sin_s(beta),
    ...
    addSpectrum(
        ...
        {
            {csl::sum_s(
                 {csl::prod_s({csl::pow_s(V_cb, 2), csl::pow_s(M_q1L, 2)}),
                  csl::prod_s({V_tb,
                               csl::GetComplexConjugate(V_tb),
                               csl::pow_s(M_q3L, 2)}),
                  csl::prod_s(
                      {csl::pow_s(M_q1L, 2),
                       csl::pow_s(V_ub_mod, 2),
                       csl::exp_s(csl::prod_s({CSL_I, delta_wolf})),
                       csl::exp_s(csl::prod_s({-1, CSL_I, delta_wolf}))}),
                  csl::prod_s({csl::intfraction_s(-1, 2),
                               csl::pow_s(M_W, 2),
                               csl::pow_s(csl::sin_s(beta), 2)}),
                  csl::prod_s(
            ...
            {0,
             csl::sum_s(
                 {csl::prod_s({V_tb,
                               csl::GetComplexConjugate(V_tb),
                               csl::pow_s(M_qbR, 2)}),
                  csl::prod_s({csl::pow_s(V_cb, 2), csl::pow_s(M_qdR, 2)}),
                  csl::prod_s(
                      {csl::pow_s(M_qdR, 2),
                       csl::pow_s(V_ub_mod, 2),
                       csl::exp_s(csl::prod_s({CSL_I, delta_wolf})),

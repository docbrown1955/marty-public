...
class MSSM_Model : public mty::Model, protected MSSM_Data {
  ...
  public:
    MSSM_Model(std::string const &saveFile = "", bool init = true);
  ...
  protected:
    ...
    void initHiggsinos();
    void initSUSYMap();
    void addSUSYPair(mty::Particle const &first, mty::Particle const &second);
...
class MSSM_HEM : public MSSM_Model {
  ...
  public:
    MSSM_HEM(std::string const &saveFile = "");
};

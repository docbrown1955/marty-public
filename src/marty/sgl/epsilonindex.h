...
/**
 * @file epsilonindex.h
 * @brief sgl::EpsilonIndex class for the fully anti-symmetric symbol.
...
class EpsilonIndex : public AbstractGeneralizedIndex {
  ...
  public:
    EpsilonIndex(csl::Index const &mu,
                 csl::Index const &nu,
                 csl::Index const &rho,
    ...
    GExpr chisholmIdentity1(csl::Index const &mu,
                            csl::Index const &a,
                            csl::Index const &b) const;
    GExpr chisholmIdentity2(csl::Index const &mu,
                            csl::Index const &nu,
                            csl::Index const &a,
                            csl::Index const &b) const;
    GExpr chisholmIdentity2A(std::vector<csl::Index> const &rho,
                             csl::Index const &             a,
                             csl::Index const &             b) const;
    GExpr chisholmIdentity2B(std::vector<csl::Index> const &rho,
                             csl::Index const &             nu,
                             csl::Index const &             a,
                             csl::Index const &             b) const;

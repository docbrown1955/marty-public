...
void NMFV_Model::addPairMixing(Mixing mix, size_t i, size_t j)
{
...
void NMFV_Model::addMixing(MixingInfo mix)
{
    ...
    for (size_t i = 0; i != particles.size(); ++i) {
        for (size_t j = i + 1; j < particles.size(); ++j) {
            ...
            csl::Expr delta
                = csl::constant_s(deltaName, csl::ComplexProperty::Complex);
...
{
    switch (mixing) {
    case NMFV_Model::Mixing::QL:
        out << "QL";
        break;
    case NMFV_Model::Mixing::UR:
        out << "UR";
        break;
    case NMFV_Model::Mixing::DR:
        out << "DR";
        break;
    case NMFV_Model::Mixing::LL:
        out << "LL";
        break;
    case NMFV_Model::Mixing::ER:
        out << "ER";
        break;
    case NMFV_Model::Mixing::Au:
        out << "Au";
        break;
    case NMFV_Model::Mixing::Ad:
        out << "Ad";
        break;
    case NMFV_Model::Mixing::Ae:
        out << "Ae";
        break;
    }

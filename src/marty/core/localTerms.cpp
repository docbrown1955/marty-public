...
csl::Expr getLocalTerm(IntegralType                  type,
                       ...
                       std::vector<csl::Expr> const &m)
{
    switch (type) {
    case IntegralType::A:
        return getLocalATerm(indicesToString(indices), p, m);
    case IntegralType::B:
        return getLocalBTerm(indicesToString(indices), p, m);
    case IntegralType::C:
        return getLocalCTerm(indicesToString(indices), p, m);
    case IntegralType::D:
        return getLocalDTerm(indicesToString(indices), p, m);
    case IntegralType::E:
        return getLocalETerm(indicesToString(indices), p, m);
    default:
        break;
    }
...
csl::Expr getLocalATerm(std::string const &indices,
...
csl::Expr getLocalBTerm(std::string const &           indices,
                        ...
                        std::vector<csl::Expr> const &masses)
{
    ...
    if (indices == "00001")
        return CSL_1 / 240
               * (p4 - 4 * p2 * m0_2 - 6 * p2 * m1_2 + 5 * m0_4
                  + 10 * m0_2 * m1_2 + 15 * m1_4);
...
csl::Expr getLocalCTerm(std::string const &           indices,
                        std::vector<csl::Expr> const &momenta,
                        std::vector<csl::Expr> const &masses)
{
    ...
    if (indices == "00001")
        return -CSL_1 / 240
               * (2 * s12 - 5 * m0_2 + 2 * p1_2 - 10 * m1_2 + p2_2 - 5 * m2_2);

    if (indices == "00002")
        return -CSL_1 / 240
               * (2 * s12 - 5 * m0_2 + p1_2 - 5 * m1_2 + 2 * p2_2 - 10 * m2_2);
    ...
    if (indices == "000000")
        return -CSL_1 / 2880
               * (2 * s12 * s12 - 6 * s12 * m0_2 + 30 * m0_4
                  ...
                  + (2 * p1_2 * p2_2 - 6 * p1_2 * m2_2 - 6 * p2_2 * m1_2
                     + 30 * m1_2 * m2_2));

    if (indices == "000011")
        return CSL_1 / 720
               * (3 * s12 - 6 * m0_2 + 3 * p1_2 - 18 * m1_2 + p2_2 - 6 * m2_2);

    if (indices == "000022")
        return CSL_1 / 720
               * (3 * s12 - 6 * m0_2 + p1_2 - 6 * m1_2 + 3 * p2_2 - 18 * m2_2);

    if (indices == "000012")
        return CSL_1 / 720
               * (2 * s12 - 3 * m0_2 + p1_2 - 6 * m1_2 + p2_2 - 6 * m2_2);
    ...
    if (indices == "0000001")
        return CSL_1 / 10080
               * (3 * s12 * s12 - 7 * s12 * m0_2 + 21 * m0_4
                  ...
                  + (2 * p1_2 * p2_2 - 7 * p1_2 * m2_2 - 7 * p2_2 * m1_2
                     + 42 * m1_2 * m2_2));
    ...
    if (indices == "0000111")
        return -CSL_1 / 1680
               * (4 * s12 - 7 * m0_2 + 4 * p1_2 - 28 * m1_2 + p2_2 - 7 * m2_2);

    if (indices == "0000222")
        return -CSL_1 / 1680
               * (4 * s12 - 7 * m0_2 + 4 * p2_2 - 28 * m2_2 + p1_2 - 7 * m1_2);

    if (indices == "0000112" or indices == "0000122")
        return -CSL_1 / 5040
               * (6 * s12 - 7 * m0_2 + 3 * p1_2 - 21 * m1_2 + 2 * p2_2
                  - 14 * m2_2);
...
csl::Expr getLocalDTerm(std::string const &           indices,
                        std::vector<csl::Expr> const &momenta,
                        std::vector<csl::Expr> const &masses)
{
    csl::Expr p1   = momenta[0];
    ...
    if (indices == "0000001")
        return -CSL_1 / 2880
                   * (2 * p1_2 + p2_2 + p3_2 + 2 * s12 + 2 * s13 + s23)
               + CSL_1 / 480 * (m0_2 + m1_2 + m2_2 + m3_2);

    if (indices == "0000002")
        return -CSL_1 / 2880
                   * (p1_2 + 2 * p2_2 + p3_2 + 2 * s12 + s13 + 2 * s23)
               + CSL_1 / 480 * (m0_2 + m1_2 + m2_2 + m3_2);

    if (indices == "0000003")
        return -CSL_1 / 2880
                   * (p1_2 + p2_2 + 2 * p3_2 + s12 + 2 * s13 + 2 * s23)
               + CSL_1 / 480 * (m0_2 + m1_2 + m2_2 + m3_2);
    ...
    if (indices == "0000112" or indices == "0000113" or indices == "0000223"
        or indices == "0000122" or indices == "0000133"
        or indices == "0000233")
        return CSL_1 / 720;
...
csl::Expr getLocalETerm(std::string const &indices,
                        std::vector<csl::Expr> const &,
                        std::vector<csl::Expr> const &)
{
    if (indices == "000000")

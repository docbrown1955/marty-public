...
class ConjugationInfo {
  ...
  public:
     ...
     */
    static ConjugationList resolveFermionLines(FieldList        init,
     ...
     */
    static ConjugationList
    resolveFermionLines(FieldList const &                init,
    ...
    static void
    applyConjugation(ConjugationList infoList, csl::Expr &expr, bool ruleMode);
  ...
  public:
     ...
     */
    explicit ConjugationInfo(csl::Index const &t_A, bool t_conjugated);
     ...
     */
    ConjugationInfo(csl::Index const &t_A,
                    csl::Index const &t_B,
     ...
     */
    void setInfo(csl::Index const &t_A,
                 csl::Index const &t_B,
                 csl::Index const &t_preA,
                 csl::Index const &t_postB);
  ...
  protected:
    ...
    void insertInChainForRule(csl::Expr &                     expr,
                              std::vector<FermionLine> const &lines) const;
...
class ConjugationList : public std::vector<ConjugationInfo> {
  ...
  public:
    ConjugationList(std::vector<ConjugationInfo> const &     info,
                    int &                                    t_sign,
    ...
    std::vector<QuantumField const *> getFinalOrder(size_t sizeHint = 10) const
    {
...
ConjugationInfo::FieldList::iterator
getExternalBegin(ConjugationInfo::FieldList &fields);
ConjugationInfo::FieldList::iterator
getInternalBegin(ConjugationInfo::FieldList &fields);
ConjugationInfo::FieldList::iterator
getBegin(ConjugationInfo::FieldList &fields);

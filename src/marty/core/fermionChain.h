...
class FermionChain {
  ...
  public:
    ...
    explicit FermionChain(const csl::Space *t_diracSpace);

    bool applyOn(csl::Expr &prod, bool makeAbbreviation = true) const;

    static std::vector<Chain> getChains(csl::Expr const & prod,

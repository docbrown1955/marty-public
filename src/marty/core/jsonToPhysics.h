 ...
 * the corresponding Model object via its only static public function
 * readModel. \param nameFile The name of the .json file. \return The Model
...
class JSONToHEP {
  ...
  private:
    ...
    /*!
     * \brief Reads the flavor in the root node of the JSON tree and returns
     * it. \param tree Pointer to to root Node. \return A raw pointer to a
     * newly allocated Flavor.
     */

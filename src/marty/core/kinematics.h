...
class Kinematics {
  ...
  public:
     ...
     */
    explicit Kinematics(std::vector<mty::Insertion> const &t_insertions);
     ...
     */
    static void
    replace(csl::Expr &expr, Kinematics const &k1, Kinematics const &k2);
     ...
     */
    friend std::ostream &operator<<(std::ostream &out, Kinematics const &kin);
  ...
  private:
     ...
     */
    void
    addContraction(csl::Tensor &p1, csl::Tensor &p2, csl::Expr const &res);

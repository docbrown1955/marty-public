...
inline lti_complex_t A0iC(int                                id,
                          lti_complex_t const &              m1,
                          [[maybe_unused]] lti_real_t const &eps = 0.)
{
    const std::complex<lti_real_t> res = ::A0iC(id, ensure_std_complex(m1));
    return lti_complex_t{res.real(), res.imag()};
}

inline lti_complex_t B0iC(int                                id,
                          lti_complex_t                      p1,
                          lti_complex_t                      m1,
                          lti_complex_t                      m2,
                          [[maybe_unused]] lti_real_t const &eps = 0.)
{
    const std::complex<lti_real_t> res = ::B0iC(id,
...
inline lti_complex_t C0iC(int               id,
                          lti_complex_t     p1,
                          lti_complex_t     p2,
                          lti_complex_t     p3,
                          lti_complex_t     m1,
                          ...
                          lti_real_t const &eps = 0.)
{
    ...
    const std::complex<lti_real_t> res = ::C0iC(id,
                                                ensure_std_complex(p1),
...
inline lti_complex_t D0iC(int                                id,
                          lti_complex_t                      p1,
                          lti_complex_t                      p2,
                          lti_complex_t                      p3,
                          lti_complex_t                      p4,
                          ...
                          [[maybe_unused]] lti_real_t const &eps = 0.)
{
    const std::complex<lti_real_t> res = ::D0iC(id,
                                                ensure_std_complex(p1),
                                                ensure_std_complex(p2),
                                                ensure_std_complex(p3),
...
inline lti_complex_t E0iC(int                                id,
                          lti_complex_t                      p1,
                          lti_complex_t                      p2,
                          lti_complex_t                      p3,
                          lti_complex_t                      p4,
                          ...
                          [[maybe_unused]] lti_real_t const &eps = 0.)
{
    const std::complex<lti_real_t> res = ::E0iC(id,
                                                ensure_std_complex(p1),
                                                ensure_std_complex(p2),
                                                ensure_std_complex(p3),
                                                ensure_std_complex(p4),

...
std::array<Type, N> toArray(std::vector<Type> const &vec)
{
    HEPAssert(vec.size() == N,
              mty::error::TypeError,
              "Expecting a vector of size " + toString(N)
                  + " in conversion"
                    ", vector of size "
...
csl::Expr getLastEvenSOIndex(std::vector<int> const &rep,
                             size_t                  n,
                             bool                    normalize = true);
...
inline constexpr std::array<GIndex_t<6>, 12> I2_E6_data
...
inline constexpr std::array<GIndex_t<6>, 12> I5_E6_data
    = {GIndex_t<6>({{1, 0, 0, 0, 0, 0}, 1}),
       GIndex_t<6>({{0, 0, 0, 0, 1, 0}, -1}),
...
inline constexpr std::array<GIndex_t<6>, 12> I6_E6_data
    = {GIndex_t<6>({{1, 0, 0, 0, 0, 0}, 1}),
       GIndex_t<6>({{0, 0, 0, 0, 1, 0}, 1}),
...
inline constexpr std::array<GIndex_t<6>, 12> I8_E6_data
    = {GIndex_t<6>({{1, 0, 0, 0, 0, 0}, 1}),
       GIndex_t<6>({{0, 0, 0, 0, 1, 0}, 1}),
...
inline constexpr std::array<GIndex_t<6>, 12> I9_E6_data
    = {GIndex_t<6>({{1, 0, 0, 0, 0, 0}, 1}),
       GIndex_t<6>({{0, 0, 0, 0, 1, 0}, -1}),
       GIndex_t<6>({{0, 0, 0, 0, 0, 1}, 0}),
...
inline constexpr std::array<GIndex_t<6>, 12> I12_E6_data
    = {GIndex_t<6>({{1, 0, 0, 0, 0, 0}, 1}),
       GIndex_t<6>({{0, 0, 0, 0, 1, 0}, 1}),
...
inline constexpr std::array<GIndex_t<7>, 21> I2_E7_data
...
inline constexpr std::array<GIndex_t<7>, 21> I6_E7_data
    = {GIndex_t<7>({{0, 0, 0, 0, 0, 1, 0}, 1}),
...
inline constexpr std::array<GIndex_t<7>, 21> I8_E7_data
    = {GIndex_t<7>({{0, 0, 0, 0, 0, 1, 0}, 1}),
...
inline constexpr std::array<GIndex_t<7>, 21> I10_E7_data
    = {GIndex_t<7>({{0, 0, 0, 0, 0, 1, 0}, 1}),
       GIndex_t<7>({{1, 0, 0, 0, 0, 0, 0}, -2}),
...
inline constexpr std::array<GIndex_t<7>, 21> I12_E7_data
    = {GIndex_t<7>({{0, 0, 0, 0, 0, 1, 0}, 1}),
...
inline constexpr std::array<GIndex_t<8>, 29> I2_E8_data
...
inline constexpr std::array<GIndex_t<8>, 29> I8_E8_data
    = {GIndex_t<8>({{1, 0, 0, 0, 0, 0, 0}, 1}),
...
inline constexpr std::array<GIndex_t<8>, 29> I12_E8_data
    = {GIndex_t<8>({{1, 0, 0, 0, 0, 0, 0}, 1}),
...
inline constexpr std::array<GIndex_t<4>, 7> I2_F4_data
...
inline constexpr std::array<GIndex_t<4>, 7> I6_F4_data
    = {GIndex_t<4>({{0, 0, 0, 1}, 1}),
...
inline constexpr std::array<GIndex_t<4>, 7> I8_F4_data
    = {GIndex_t<4>({{0, 0, 0, 1}, 1}),
...
inline constexpr std::array<GIndex_t<4>, 7> I12_F4_data
    = {GIndex_t<4>({{0, 0, 0, 1}, 1}),
...
inline constexpr std::array<GIndex_t<2>, 16> I2_G2_data
    = {GIndex_t<2>({{0, 1}, 1}),
       GIndex_t<2>({{1, 0}, 4}),
       GIndex_t<2>({{0, 2}, 9}),
       GIndex_t<2>({{1, 1}, 32}),
...
inline constexpr std::array<GIndex_t<2>, 16> I6_G2_data
    = {GIndex_t<2>({{0, 1}, 1}),
       GIndex_t<2>({{1, 0}, -26}),
       GIndex_t<2>({{0, 2}, 39}),
       GIndex_t<2>({{1, 1}, -208}),

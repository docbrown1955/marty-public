...
class Object {
  ...
  public:
     ...
     */
    explicit Object(std::string const &t_specifier) : specifier(t_specifier)
    {
    }
...
class Node : public Object {
  ...
  public:
     ...
     */
    explicit Node(std::string const &specifier) : Object(specifier)
    {
    }
...
class List : public Node {
  ...
  public:
     ...
     */
    explicit List(std::string const &specifier) : Node(specifier)
    {
    }

    static std::unique_ptr<List> make(std::string const &specifier)
    {
...
class AbstractLeaf : public Object {
  public:
     ...
     */
    explicit AbstractLeaf(std::string const &specifier) : Object(specifier)
    {
    }

...
ToolBar::ToolBar(QWidget *parent) : QWidget(parent), ui(new Ui::ToolBar)
{
    ui->setupUi(this);

    connect(ui->normalButton,
            SIGNAL(clicked(bool)),
            this,
            SLOT(removeChecked(bool)));
    connect(
        ui->addButton, SIGNAL(clicked(bool)), this, SLOT(addChecked(bool)));
    connect(ui->selectButton,
            SIGNAL(clicked(bool)),
            this,
            SLOT(selectChecked(bool)));
}

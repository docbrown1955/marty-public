...
class Wick: public csl::Operator<csl::AbstractFunc> {
     ...
     * \param expr csl::Expr in which we search quantum fields. Must be a single
     * field or a power of field.
     * \return The number of quantum fields in expr if it is a field or power of
     * fields.
     * \return -1 else.
     */

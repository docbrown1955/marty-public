...
class QuantumNumber {
     ...
     * \details This is used to define the id of new quantum numbers. Each time,
     ...
     * \param t_conserved Boolean. If true, the quantum number is conserved and may be used to simplify calculations.
     */
    ...
    /*!
     * \brief Tells if one of the fields has a non trivial value for the quantum
     * number.
     * \param fields List of fields.
     * \return \b True  if one of the fields has a non trivial value for the 
     * quantum number.
     * \return \b False else.
     */

...
void PMSSM_LEM::initKinetic0()
{
    ...
    addLagrangianTerm(
        ...
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, M_W, csl::cos_s(beta), W({i_Minko[ 0 ]}, X), csl::tderivativeelement_s(X, d_der, {+i_Minko[ 0 ]}, csl::GetComplexConjugate(Hp(X)), 0)}),
        false);
    addLagrangianTerm(
        csl::prod_s({-1
...
, M_Z, csl::cos_s(beta), Z({i_Minko[ 0 ]}, X), csl::tderivativeelement_s(X, d_der, {+i_Minko[ 0 ]}, A0(X), 0)}),
    ...
    addLagrangianTerm(
        ...
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 1 ]}), csl::GetComplexConjugate(u({+i_C_1_0[ 0 ], +i_dirac[ 0 ]}, X)), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, u({+i_C_1_0[ 0 ], +i_dirac[ 1 ]}, X), 0)}),
        false);
    addLagrangianTerm(
        ...
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 1 ]}), csl::GetComplexConjugate(d({+i_C_1_0[ 0 ], +i_dirac[ 0 ]}, X)), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, d({+i_C_1_0[ 0 ], +i_dirac[ 1 ]}, X), 0)}),
        false);
    addLagrangianTerm(
        ...
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 1 ]}), csl::GetComplexConjugate(e({+i_dirac[ 0 ]}, X)), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, e({+i_dirac[ 1 ]}, X), 0)}),
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 1 ]}), csl::GetComplexConjugate(mu({+i_dirac[ 0 ]}, X)), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, mu({+i_dirac[ 1 ]}, X), 0)}),
        false);
    addLagrangianTerm(
        ...
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 1 ]}), csl::GetComplexConjugate(nu_e({+i_dirac[ 0 ]}, X)), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, nu_e({+i_dirac[ 1 ]}, X), 0)}),
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 1 ]}), csl::GetComplexConjugate(nu_mu({+i_dirac[ 0 ]}, X)), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, nu_mu({+i_dirac[ 1 ]}, X), 0)}),
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 1 ]}), csl::GetComplexConjugate(nu_tau({+i_dirac[ 0 ]}, X)), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, nu_tau({+i_dirac[ 1 ]}, X), 0)}),
        false);
    addLagrangianTerm(
...
void PMSSM_LEM::initKinetic1()
{
    ...
    addLagrangianTerm(
        ...
        false);
    addLagrangianTerm(
        csl::prod_s({csl::tderivativeelement_s(X, d_der, {+i_Minko[ 0 ]}, snu_e(X), 0), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, csl::GetComplexConjugate(snu_e(X)), 0)}),
        false);
    addLagrangianTerm(
        csl::prod_s({csl::tderivativeelement_s(X, d_der, {+i_Minko[ 0 ]}, snu_mu(X), 0), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, csl::GetComplexConjugate(snu_mu(X)), 0)}),
        false);
    addLagrangianTerm(
        csl::prod_s({csl::tderivativeelement_s(X, d_der, {+i_Minko[ 0 ]}, snu_tau(X), 0), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, csl::GetComplexConjugate(snu_tau(X)), 0)}),
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, C({+i_dirac[ 0 ], +i_dirac[ 1 ]}), C({+i_dirac[ 2 ], +i_dirac[ 3 ]}), gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 3 ]}), C_1_R({+i_dirac[ 1 ]}, X), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, csl::GetComplexConjugate(C_1_R({+i_dirac[ 2 ]}, X)), 0)}),
        false);
    addLagrangianTerm(
        csl::prod_s({CSL_I, C({+i_dirac[ 0 ], +i_dirac[ 1 ]}), C({+i_dirac[ 2 ], +i_dirac[ 3 ]}), gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 3 ]}), C_2_R({+i_dirac[ 1 ]}, X), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, csl::GetComplexConjugate(C_2_R({+i_dirac[ 2 ]}, X)), 0)}),
        false);
    addLagrangianTerm(
...
, CSL_I, gamma({+i_Minko[ 0 ], +i_dirac[ 0 ], +i_dirac[ 2 ]}), gamma5({+i_dirac[ 2 ], +i_dirac[ 1 ]})})}), csl::GetComplexConjugate(N_4({+i_dirac[ 0 ]}, X)), csl::tderivativeelement_s(X, d_der, {i_Minko[ 0 ]}, N_4({+i_dirac[ 1 ]}, X), 0)}),
    ...
    addLagrangianTerm(
        ...
        false);
    addLagrangianTerm(
        csl::prod_s({M_W, csl::sum_s({1 , csl::prod_s({CSL_I, csl::sin_s(beta)})}), csl::GetComplexConjugate(W({i_Minko[ 0 ]}, X)), csl::tderivativeelement_s(X, d_der, {+i_Minko[ 0 ]}, Gp(X), 0)}),
        false);
    addLagrangianTerm(

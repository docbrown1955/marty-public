...
AbstractParent::AbstractParent(const string& t_name)
    :commutable(true)
{
    setName(t_name);
}
...
void AbstractParent::printPropDefinition(
        std::ostream &out,
        int           indentSize,
        bool          header
        ) const
...
optional<Expr> AbstractParent::evaluate(
        Expr_info,
        csl::eval::mode) const
{
    return nullopt;
...
bool AbstractParent::hasContractionProperty(const Abstract*,
                                    Expr_info) const
{
    std::cout << getName() << ": type " << getType() << std::endl;
    callError(cslError::AbstractFuncCalled,
...
Expr AbstractParent::contraction(const Abstract*, Expr_info) const
{
    std::cout << getName() << ": type " << getType() << std::endl;
    callError(cslError::AbstractFuncCalled,
            "AbstractParent::contraction(const Abstract* self, Expr_info B) const");
    return false;
}
        ...
        optional<function<bool(Expr_info, Expr_info)>>)
{
    std::cout << getName() << ": type " << getType() << std::endl;
    callError(cslError::AbstractFuncCalled,
            "AbstractParent::addSelfContraction(const Expr& A, const Expr& B, const Expr& res)");
}

void AbstractParent::removeSelfContraction(
        const Expr&,
        const Expr&
        )
{
    std::cout << getName() << ": type " << getType() << std::endl;
    callError(cslError::AbstractFuncCalled,
            "AbstractParent::removeSelfContraction(const Expr& A, const Expr& B, const Expr& res)");
}
...
void AbstractParent::addContractionProperty(
        csl::vector_expr const&,
        const Expr&)
{
    std::cout << getName() << ": type " << getType() << std::endl;
    callError(cslError::AbstractFuncCalled,
...
void AbstractParent::removeContractionProperty(
        csl::vector_expr const&,
        const Expr&)
{
    std::cout << getName() << ": type " << getType() << std::endl;
...
optional<Expr> AbstractParent::getComplexProperty(
        Expr_info
        ) const
{
    return nullopt;
...
optional<Expr> AbstractParent::getHermitianProperty(
        Expr_info,
        const Space*) const
{
    return nullopt;
...
optional<Expr> AbstractParent::getTransposedProperty(
        Expr_info,
        const Space*) const
{
    return nullopt;
...
void AbstractParent::addComplexProperty(const Expr&,
                                        const Expr&)
{
    std::cout << getName() << ": type " << getType() << std::endl;
    callError(cslError::AbstractFuncCalled,

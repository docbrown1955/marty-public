...
class IntFactorial: public AbstractLiteral{
     ...
     * \return \b value
     */
    long double getValue() const override { return value;}

    /*! \brief Gives the **primary type** of a IntFraction.
     * \details The **primary type** is the same as the one of Variable.
     * \return \b 1
     */
    csl::PrimaryType getPrimaryType() const override { return csl::PrimaryType::Literal;};

    /*! \brief Gives the \b type of a IntFraction.
     * \return \b 3
     */
    csl::Type getType() const override { return csl::Type::IntFactorial;};
...
class Imaginary: public AbstractLiteral{
     ...
     * \return \b 4
     */
    csl::Type getType() const override { return csl::Type::Imaginary;}
...
inline IntFactorial::IntFactorial()
    :AbstractLiteral(),
    value(0)
{
 ...
 */
inline const csl::Expr CSL_PI = csl::constant_s(
        "\\pi",
        M_PI,
 ...
 */
inline const csl::Expr CSL_E = csl::constant_s(
        "e",
        M_E,
        csl::ComplexProperty::Real);
 ...
 * should return \bCSL_INF. \bCSL_INF is treated like a Variable. It is simply here 
 * to inform the user that *something bad happened** in the expr.
 * \bug Will not work for many cases, in particular log(0)!=\bCSL_INF. 
 * Not yet implemented.
 */
inline const csl::Expr CSL_INF = csl::constant_s(
        "INF",
        csl::ComplexProperty::Real);
 ...
 */
inline const csl::Expr CSL_UNDEF = csl::constant_s(
        "CSL_UNDEF",
        csl::ComplexProperty::Real);

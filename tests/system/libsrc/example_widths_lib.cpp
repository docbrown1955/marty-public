...
struct Kin_1_to_2 {
    ...
    static Kin_1_to_2 build(double const M0, double const M1, double const M2)
    {
...
Kin_1_to_2 fillKinematics_1to2(Param_t     &param,
                               double const M0,
                               double const M1,
                               double const M2)
{
...
double width(double const m2, const Kin_1_to_2 &kin)
{
...
double Gamma_hbb(param_t const &param, double const mh)
{
...
double Gamma_hWW(param_t const &param, double const mh, double const MW)
{

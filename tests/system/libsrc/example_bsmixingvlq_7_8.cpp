...
int main()
{
    ...
    for (double M = 10; M < 10000; M += 100) {
        ...
        std::cout << "M = " << M << '\n';
        std::cout << "C_VLL = "
                  << Cmix_VLL(params).real() / factor(params.M_Td, params.M_Tu)
                  << '\n';
        std::cout << "C_VRR = "
                  << Cmix_VRR(params).real() / factor(params.M_Td, params.M_Tu)
                  << '\n';
        std::cout << "C_VLR = "
                  << Cmix_VLR(params).real() / factor(params.M_Td, params.M_Tu)
                  << '\n';
        std::cout << "C_VRL = "
                  << Cmix_VRL(params).real() / factor(params.M_Td, params.M_Tu)
                  << '\n';
